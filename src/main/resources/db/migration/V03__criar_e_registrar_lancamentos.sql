CREATE TABLE lancamento (
	...
	CONSTRAINT fk_codCategoria FOREIGN KEY (codigo_categoria) REFERENCES categoria(codigo),
	CONSTRAINT fk_codPessoa FOREIGN KEY (codigo_pessoa) REFERENCES pessoa(codigo)	
