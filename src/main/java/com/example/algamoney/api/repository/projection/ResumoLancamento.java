...
public class ResumoLancamento {
	...
	public ResumoLancamento(Long codigo, String descricao, LocalDate dataVencimento, LocalDate dataPagamento,
			BigDecimal valor, TipoLancamento tipo, String categoria, String pesssoa) {
		super();
		this.codigo = codigo;
	...
	public String getPesssoa() {
		return pesssoa;
	}
	
	public void setPesssoa(String pesssoa) {
		this.pesssoa = pesssoa;
	}	
}
